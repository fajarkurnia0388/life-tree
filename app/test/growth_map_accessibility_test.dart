...
void main() {
  group('GrowthMap Accessibility Semantics Tests', () {
    test('RootNode semantic label contains core values', () {
      ...
      final label = GrowthMapSemantics.buildLabel(node);
    ...
    test('BranchNode semantic label contains domain status and score', () {
      ...
      final label = GrowthMapSemantics.buildLabel(node);
      expect(label, contains('Dahan Tubuh'));
    ...
    test('LeafNode semantic label contains habit title and status', () {
      ...
      final labelDone = GrowthMapSemantics.buildLabel(nodeDone);
      expect(labelDone, contains('Daun Kebiasaan: Minum Air Hangat'));
      ...
      final labelPending = GrowthMapSemantics.buildLabel(nodePending);
