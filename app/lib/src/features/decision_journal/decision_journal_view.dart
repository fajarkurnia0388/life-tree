                    ...
                    Column(
                      ...
                      children: [
                        Text(
                          ...
                          style: TextStyle(fontSize: 10, color: theme.colorScheme.onBackground.withOpacity(0.5)),
                        ),
                        Text(
                          ...
                          style: TextStyle(
                            ...
                            color: isOverdue ? theme.colorScheme.error : theme.colorScheme.onBackground.withOpacity(0.5),
                          ),
                        ),
                      ],
                    ),
