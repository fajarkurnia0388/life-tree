...
class TreeSkinShopBottomSheet extends ConsumerStatefulWidget {
  ...
  const TreeSkinShopBottomSheet({super.key, required this.profile, required this.onSuccess});

  @override
  ConsumerState<TreeSkinShopBottomSheet> createState() => _TreeSkinShopBottomSheetState();
}

class _TreeSkinShopBottomSheetState extends ConsumerState<TreeSkinShopBottomSheet> {
          ...
          if (_isProcessing)
            ...
            ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final isUnlocked = widget.profile.isDeveloperMode || unlockedList.contains(s['id']);
